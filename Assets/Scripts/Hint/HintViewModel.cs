public class HintViewModel : ViewModel
{
    ...
    public async System.Threading.Tasks.Task<bool> IsInternetReachable()
    {
        return true;
        //return await AdsManager.IsInternetReachable();
    }
    ...
    public class Data //: ISaveable
    {
        ...
        public string FileName => "hint_data";//ISaveable？？
    }
}
...
public class Transition : MonoBehaviour
{
    ...
    [Header("暂时缺 Dotween parts-Ease 缩放")]
    ...
    public void StartInAnimation() {
        isLoading = true;
        Animate(0, 1);
        ACTimer.StartNew(this, partsAnimationDuration, () => {
    ...
    public void Close() {
        ...
        mainText.text = "Done";
        ACTimer.StartNew(this, 0.3f, () => Animate(_canvasHeight, 0));
        ACTimer.StartNew(this, 0.3f + partsAnimationDuration, () => gameObject.SetActive(false));
    }
